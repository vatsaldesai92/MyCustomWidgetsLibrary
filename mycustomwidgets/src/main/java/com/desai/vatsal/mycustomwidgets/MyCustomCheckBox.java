...
public class MyCustomCheckBox extends CheckBox {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MyCustomCheckBox, 0, 0);

            try {

                String strFontPath = a.getString(R.styleable.MyCustomCheckBox_fontPath);
